...
/**
 * Created by poornashekarreddy.p on 13-09-2017.
 */

public class Fpescp extends Fragment {
    View rootView;
    RecyclerView recyclerView;
    Adapterb adapterb;
    ArrayList<Modelb> arrayList=new ArrayList();
    String url="http://34.210.77.132:3009/psr/down/pescp";
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fpescp, container, false);
